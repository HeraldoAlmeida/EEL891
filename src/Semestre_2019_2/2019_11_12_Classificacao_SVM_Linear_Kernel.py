...
print ( 'Precision   = %f %%' % (100*precision_score(y_test,y_test_pred,average='macro')) )
print ( 'Sensitivity = %f %%' % (100*recall_score(y_test,y_test_pred,average='macro')) )
print ( 'F1          = %f %%' % (100*f1_score(y_test,y_test_pred,average='macro')) )
...
for k in range(-40,-29,1):
    
    m = k/10
    c = 10.0
    g = 10**m
    
    rbfSVC = SVC(kernel='rbf', gamma=g, C=c)
