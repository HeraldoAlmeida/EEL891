...
print ( 'DENTRO da amostra:' )
print ( 'Accuracy:    ' + str(accuracy_score(y_train, y_train_pred)) )
print ( 'Precision:   ' + str(precision_score(y_train, y_train_pred,average=None)) )
print ( 'Sensitivity: ' + str(recall_score(y_train, y_train_pred,average=None)) )
print ( 'F1 Score:    ' + str(f1_score(y_train, y_train_pred,average=None)) )

print ( 'FORA da amostra:' )
print ( 'Accuracy:    ' + str(accuracy_score(y_test, y_test_pred)) )
print ( 'Precision:   ' + str(precision_score(y_test, y_test_pred,average=None)) )
print ( 'Sensitivity: ' + str(recall_score(y_test, y_test_pred,average=None)) )
print ( 'F1 Score:    ' + str(f1_score(y_test, y_test_pred,average=None)) )
